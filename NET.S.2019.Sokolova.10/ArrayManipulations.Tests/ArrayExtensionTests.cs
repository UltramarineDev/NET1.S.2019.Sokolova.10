...
namespace ArrayManipulations.Tests
{
    public class ArrayExtensionTests
    {
        ...
        {
            Assert.Throws<ArgumentException>(() => ArrayExtension.Filter(new int[] { }, new FilterArrayByKey<int>(8)));
        }
        ...
        public void Sort_EmptyArray_ThrowArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() => array.SortBy(new SortingByOccurrenceDescendingComparator<string>('u')));
        }
        ...
        public void Transform_EmptyArray_ThrowArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(() => array.Transform(new TransformatorEng<double, string>()));
        }
